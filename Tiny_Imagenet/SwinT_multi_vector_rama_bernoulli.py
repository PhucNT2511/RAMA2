...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='PyTorch Tiny ImageNet Training with SwinT and Bernoulli RAMA Layers')
    ...
    parser.add_argument('--at-attack', default='fgsm', choices=['fgsm', 'pgd'], help='adversarial attack type')
