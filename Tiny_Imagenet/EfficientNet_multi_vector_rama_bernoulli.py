...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='PyTorch Tiny ImageNet Training with EfficientNet-B2 and Bernoulli RAMA Layers')
    ...
    parser.add_argument('--at-epsilon', default=0.03, type=float, help='epsilon for adversarial training attack') # Separate from eval epsilon
