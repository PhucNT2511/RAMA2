...
def ResNet18(num_classes=10, use_rama=False, rama_config=None, rama_positions=None, rama_type='bernoulli'):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes, use_rama, rama_config, rama_positions, rama_type)


def ResNet34(num_classes=10, use_rama=False, rama_config=None, rama_positions=None, rama_type='bernoulli'):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes, use_rama, rama_config, rama_positions, rama_type)


def ResNet50(num_classes=10, use_rama=False, rama_config=None, rama_positions=None, rama_type='bernoulli'):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes, use_rama, rama_config, rama_positions, rama_type)


def ResNet101(num_classes=10, use_rama=False, rama_config=None, rama_positions=None, rama_type='bernoulli'):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes, use_rama, rama_config, rama_positions, rama_type)


def ResNet152(num_classes=10, use_rama=False, rama_config=None, rama_positions=None, rama_type='bernoulli'):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes, use_rama, rama_config, rama_positions, rama_type)
