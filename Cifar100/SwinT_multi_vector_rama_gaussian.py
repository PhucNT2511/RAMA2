...
class Trainer:
    ...
    def train(self, epochs, start_epoch=0):
        ...
        for epoch in range(start_epoch, epochs):
            ...
            metrics = self.evaluate_with_metrics(lambda_value=self.best_lambda, epoch=epoch)
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='PyTorch CIFAR-100 Training with SwinT and Gaussian RAMA Layers')
